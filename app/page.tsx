...
Bridging innovation and accessibility in healthcare through intelligent systems.
      ...
      <div className="lg:hidden pt-16">
        ...
        >
          ...
          <p className="text-neutral-300 text-[13px] xl:text-[15px] leading-relaxed font-sans">
            AI/ML researcher from M'sila, Algeria. Focused on medical imaging, deep learning, and real-world clinical AI. Bridging innovation and accessibility in healthcare through intelligent systems.
          </p>
        </section>
