...
                  }
                  className="w-full flex justify-between items-center px-8 xl:px-10 py-4 xl:py-5 text-left" // Spacing reduced
                >
                  <div>
                    <div className="text-base xl:text-lg font-semibold font-mono"> {/* Font size reduced */}
                      {p.name}
                    </div>
...
                  </div>
                  
                  {/* Project Link - Visible only when active */}
                  {activeProject === p.id && (
                    <a
                      href={p.link}
                      target="_blank"
                      rel="noreferrer"
                      onClick={(e) => e.stopPropagation()} // Prevents collapsing when clicking the link
                      className="arrow-animate inline-flex items-center gap-2 text-white text-[12px] xl:text-[13px] tracking-wide font-mono ml-auto mr-5 flex-shrink-0"
                    >
                      <span className="hidden xl:inline">{p.linkText}</span>
                      <svg
                        width="14"
                        height="14"
                        viewBox="0 0 24 24"
...
                  setActiveProject(activeProject === p.id ? null : p.id)
                }
                className="w-full flex justify-between items-center px-6 py-4 text-left" // Spacing reduced
              >
                <div>
                  <div className="text-sm font-semibold font-mono"> {/* Font size reduced */}
                    {p.name}
                  </div>
...
                </div>
                
                {/* Project Link - Visible only when active (Mobile) */}
                {activeProject === p.id && (
                  <a
                    href={p.link}
                    target="_blank"
                    rel="noreferrer"
                    onClick={(e) => e.stopPropagation()} // Prevents collapsing when clicking the link
                    className="arrow-animate inline-flex items-center gap-1.5 text-white text-[10px] tracking-wide font-mono ml-auto mr-3 flex-shrink-0"
                  >
                    <span className="hidden sm:inline">{p.linkText}</span>
                    <svg
                      width="12"
                      height="12"
                      viewBox="0 0 24 24"
