      ...
      <div className="flex flex-col gap-3">         
        ...
        >           
          <div className="flex items-start justify-end">             
            {/* FIX: Replaced inline SVG with <img> tag, using invert for "almost white" color and size classes */}
            <img 
              src="/ai.svg" 
              alt="AI icon" 
              // 'invert' flips black to white; w-20 h-20 sets the size.
        ...
        >           
          <div className="flex items-start justify-start">             
            {/* FIX: Replaced inline SVG with <img> tag, using invert and size classes */}
            <img
              src="/noun.svg"
              alt="About icon"
              // 'invert' flips black to white (the original SVG was line art)
              // We'll use the same sizing as the previous SVG's parent container
